...
def placement_option():
    ...
    print(f"Number of tiles for {type_of_ships[2]} : 2", end=" " * 5)
    print(f"Number of tiles for {type_of_ships[4]} : 3")
    print(f"Number of tiles for {type_of_ships[8]} : 4", end=" " * 5)
    print(f"Number of tiles for {type_of_ships[9]} : 5", end=" " * 5)
    print("\n\nPlease Use Value between A-J and 1-10: Example Input: B4, D1, G5")


def placement(player1):
    ...
    while placing:
        ...
        if test and (10 >= num_value > 0):
            if alp_value in ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J']:
                ...
                print("Please Use Value between A-J and 1-10: Example Input: B4, D1, G5")
        else:
            print("Please Use Value between A-J and 1-10: Example Input: B4, D1, G5")
    return player1
